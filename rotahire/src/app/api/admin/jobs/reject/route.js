...
export async function POST(request) {
  try {
    ...
    if (updateError) {
      ...
      return NextResponse.json(
        { success: false, error: 'Failed to reject job' },
        { status: 500 }
      );
    }
    ...
    // TODO: Send notification email to company with feedback
    ...
    console.error('Error in reject job:', error);
    return NextResponse.json(
